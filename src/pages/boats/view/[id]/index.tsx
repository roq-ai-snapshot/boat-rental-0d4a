...
import { getBoatById } from 'apiSdk/boats';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('boat', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/boats/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('rental', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/rentals/create?boat_id=${data?.id}`}>
