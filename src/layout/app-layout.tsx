...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['boat-owner', 'rental-business-owner', 'rental-business-employee'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Boat', path: '/boats', entity: 'boat', service: AccessServiceEnum.PROJECT, icon: FiBox },
